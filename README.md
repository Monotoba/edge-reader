...
- **Document navigator:** Dockable panel on the left showing document paragraphs. Click any paragraph to jump to it.
- **Jump to any location:** Double-click anywhere in the text or click a paragraph in the navigator to skip ahead or go back (perfect for skipping legal text, indexes, TOCs, etc.).
